                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center mt-2">
                                {order.some((item) => item.id === product._id) ? (
                                    <div className="flex items-center">
                                        <button
                                            id="decrementButton"
                                            className="bg-gray-400 hover:bg-gray-700 text-white font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-md mb-1 sm:mb-0"
                                        ...
                                        <button
                                            id="incrementButton"
                                            className="bg-gray-400 hover:bg-gray-700 text-white font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-md"
